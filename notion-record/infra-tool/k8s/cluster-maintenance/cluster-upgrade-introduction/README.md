...
I0215 12:49:23.752669   16973 version.go:261] remote version is much newer: v1.35.1; falling back to: stable-1.33
...
kubelet     controlplane   v1.33.0   v1.33.8
kubelet     node01         v1.33.0   v1.33.8

Upgrade to the latest version in the v1.33 series:

COMPONENT                 NODE           CURRENT    TARGET
kube-apiserver            controlplane   v1.33.0    v1.33.8
kube-controller-manager   controlplane   v1.33.0    v1.33.8
kube-scheduler            controlplane   v1.33.0    v1.33.8
kube-proxy                               1.33.0     v1.33.8
...
Note: Before you can perform this upgrade, you have to update kubeadm to v1.33.8.
...
- kubeadm이 클러스터를 업그레이드 하기 전에 먼저 최신 버전이어야 함
